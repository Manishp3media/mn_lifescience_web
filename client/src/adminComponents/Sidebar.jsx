...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="fixed top-0 left-0 z-50 h-[76px] flex items-center lg:hidden">
      <button
      ...
      <aside
        id="default-sidebar"
        className={`fixed top-0 left-0 z-40 w-[200px] h-screen bg-white transition-transform border-r-4 border-[#CCA66B] ${isOpen ? "translate-x-0" : "-translate-x-full"
          } lg:translate-x-0`}
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto bg-white">
          <img src="/logo.png" alt="MN Life Science" className="w-full h-[150px] object-fit mt-14 lg:mt-0" />
          <ul className="font-medium">
            <li>
              <Link
                to="/admin/dashboard/enquiries"
                className={`flex items-center text-white p-2 ${isActiveRoute("/admin/dashboard/enquiries")
                    ? "bg-[#386D62]"
            ...
            <li className="mt-3">
              <Link
                ...
                className={`flex items-center text-white p-2 ${isActiveRoute("/admin/dashboard/products")
                    ? "bg-[#386D62]"
                    : "bg-[#CCA66B] hover:bg-[#386D62]"
                  }`}
              >
            ...
            <li className="mt-3">
              <Link
                ...
                className={`flex items-center text-white p-2 ${isActiveRoute("/admin/dashboard/called-list")
                    ? "bg-[#386D62]"
                    : "bg-[#CCA66B] hover:bg-[#386D62]"
                  }`}
              >
            ...
            <li className="mt-3">
              <Link
                ...
                className={`flex items-center text-white p-2 ${isActiveRoute("/admin/dashboard/mr-list")
                    ? "bg-[#386D62]"
                    : "bg-[#CCA66B] hover:bg-[#386D62]"
                  }`}
              >
                <span className="ms-3">Admin Options</span>
              </Link>
            </li>
          </ul>
