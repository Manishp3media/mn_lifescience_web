      ...
      >
        <div className="flex flex-col h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <div className="flex items-center mb-5">
            <img src="/logo.png" alt="Accernity" className="h-12 mr-3" />
          ...
          <ul className="space-y-2 font-medium flex-grow">
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${isActiveRoute("/admin/dashboard/called-list") ? "bg-gray-100 dark:bg-gray-700" : ""
                  }`}
              >
            ...
            <li>
              <Link
                ...
                className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${isActiveRoute("/admin/dashboard/mr-list") ? "bg-gray-100 dark:bg-gray-700" : ""
                  }`}
